...
/**
 * RTCM3 Message Type 1044 - BeiDou Ephemeris Data (CNAV format)
 * 
 * @author goGPS Project
 */
public class Decode1044Msg implements Decode {

	public Decode1044Msg() {
	}
	...
	public Object decode(boolean[] bits, int week) {
		...
		// L2 Code (unused for BeiDou): 2 bits
		i += 2;
		...
		// TGD1 (Group delay B1I): 16 bits, scale 2^-35 seconds
		double tgd1 = decodeSigned(bits, i, 16) * Math.pow(2, -35);
		eph.setTgd1(tgd1);
		i += 16;
		
		// TGD2 (Group delay B2I): 16 bits, scale 2^-35 seconds
		double tgd2 = decodeSigned(bits, i, 16) * Math.pow(2, -35);
		eph.setTgd2(tgd2);
		i += 16;
