...
/**
 * RTCM3 Message Type 1045 - Galileo Ephemeris Data (I/NAV)
 * 
...
public class Decode1045Msg implements Decode {
	...
	public Object decode(boolean[] bits, int week) {
		...
		// Toe (Time of Ephemeris): 32 bits (Galileo seconds of week)
		...
		// ToC (Time of Clock): 32 bits (Galileo seconds of week)
		...
		// BGD E5a-E1: 16 bits, scale 2^-35 seconds
		double bgdE5aE1 = decodeSigned(bits, i, 16) * Math.pow(2, -35);
		eph.setBgdE5aE1(bgdE5aE1);
		i += 16;
		
		// BGD E5b-E1: 16 bits, scale 2^-35 seconds
		double bgdE5bE1 = decodeSigned(bits, i, 16) * Math.pow(2, -35);
		eph.setBgdE5bE1(bgdE5bE1);
		i += 16;
		...
		// Data Source: 2 bits
		int dataSource = (int) decodeUnsigned(bits, i, 2);
		eph.setDataSource(dataSource);
		i += 2;
